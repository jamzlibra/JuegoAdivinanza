...
public class AdivinaElNumero {
    public static void main(String[] args) {
        ...
        while (jugarDeNuevo) {
            int numeroAdivinar = random.nextInt(100) + 1; // Generar número aleatorio entre 0 a 99 + 1
            int intentos = 5;

            System.out.println("Bienvenido al juego de adivinanzas. Debes adivinar un número entre 1 y 100.");
